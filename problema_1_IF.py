""" 
Se introduc trei date de forma număr curent elev, punctaj. Afişaţi numărul elevului cu cel mai mare punctaj. Exemplu : Date de intrare nr crt 7 punctaj 120 nr crt 3 punctaj 100 
...
if ((p1>p2)and(p1>p3)): 
    print("Punctajul maxim are elevul cu numerul",n1) 
elif ((p2>p1)and(p2>p3)): 
    print("Punctajul maxim are elevul cu numerul",n2) 
elif ((p3>p1)and(p3>p2)): 
    print("Punctajul maxim are elevul cu numerul",n3) 
